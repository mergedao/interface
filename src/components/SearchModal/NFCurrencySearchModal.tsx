...
import { NFCurrencySearch } from './NFCurrencySearch'

interface NFCurrencySearchModalProps {
  isOpen: boolean
  onDismiss: () => void
...
export default function NFCurrencySearchModal({
  isOpen,
  onDismiss,
  onCurrencySelect,
  selectedCurrency,
