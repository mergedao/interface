...
import NFCurrencySearchModal from '../SearchModal/NFCurrencySearchModal'
    ...
    <SelectPanel id={id} hideInput={hideInput} {...rest}>
      ...
      <NFTFixedContainer>
        <Container hideInput={hideInput}>
          <SelectRow style={hideInput ? { padding: '0', borderRadius: '8px' } : {}} selected={!onCurrencySelect}>
            <CurrencySelect
      ...
      <Container hideInput={hideInput}>
        <NFTView
          width="100%"
          height="100%"
          src="https://storage.googleapis.com/opensea-prod.appspot.com/0x7fdcd2a1e52f10c28cb7732f46393e297ecadda1-preview/20940.png"
        ></NFTView>
      </Container>
      {onCurrencySelect && (
