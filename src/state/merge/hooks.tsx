...
export function useSwapActionHandlers(): {
  ...
  const onUserInput = useCallback(
    (field: Field.INPUT | Field.OUTPUT, typedValue: string) => {
...
export function useDerivedSwapInfo(toggledVersion: Version | undefined): {
  currencies: { [field in Field.INPUT | Field.OUTPUT]?: Currency | null }
...
function parseIndependentFieldURLParameter(urlParam: any): Field.INPUT | Field.OUTPUT {
...
export function queryParametersToSwapState(parsedQs: ParsedQs): MergeSwapState {
  let inputCurrency = parseCurrencyFromURLParameter(parsedQs.inputCurrency)
  let outputCurrency = parseCurrencyFromURLParameter(parsedQs.outputCurrency)
  const inputTokenId = parseCurrencyFromURLParameter(parsedQs.inputTokenId)
  const outputTokenId = parseCurrencyFromURLParameter(parsedQs.outputTokenId)
