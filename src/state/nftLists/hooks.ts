...
import DEFAULT_NFTOKEN_LIST from '../../constants/tokenLists/default.nftokenlist.json'
...
const TRANSFORMED_DEFAULT_TOKEN_LIST = listToTokenMap(DEFAULT_NFTOKEN_LIST)
...
export function useCombinedActiveList(): TokenAddressMap {
  ...
  return useMemo(() => combineMaps({}, TRANSFORMED_DEFAULT_TOKEN_LIST), [])
}
